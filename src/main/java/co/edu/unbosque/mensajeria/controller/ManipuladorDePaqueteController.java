...
public class ManipuladorDePaqueteController {
	...
	// http://localhost:8080/manipuladordepaquete/buscarpornombre?nombre=Pedro
		...
		// http://localhost:8080/manipuladordepaquete/buscarporcedula?cedula=456
		...
		// http://localhost:8080/manipuladordepaquete/buscarporcorreo?correo=p@mail.com
		...
		// http://localhost:8080/manipuladordepaquete/buscarportelefono?telefono=3002
		...
		// http://localhost:8080/manipuladordepaquete/buscarportipomanipulador?tipoManipulador=Bodega
		@GetMapping("/buscarportipomanipulador")
		public ResponseEntity<List<ManipuladorDePaqueteDTO>> buscarPorTipoManipulador(@RequestParam String tipoManipulador) {
		...
		// http://localhost:8080/manipuladordepaquete/buscarpornombreycedula?nombre=Pedro&cedula=456
		@GetMapping("/buscarpornombreycedula")
		public ResponseEntity<List<ManipuladorDePaqueteDTO>> buscarPorNombreAndCedula(@RequestParam String nombre, @RequestParam String cedula) {
