...
public interface ClientePremiumRepository extends CrudRepository<ClientePremium, Long> {
	...
	/**
	 * Busca clientes premium filtrando por su nombre completo. * @param nombre El
	...
	/**
	 * Busca clientes premium según su número de cédula. * @param cedula El número
	 * de identificación a consultar.
	 * 
	 * @return Un Optional que contiene la lista de clientes encontrados.
	 */
	...
	/**
	 * Busca clientes premium por su número de teléfono. * @param telefono El número
	...
	/**
	 * Busca clientes premium según el método de pago registrado. * @param
	 * metodoPago El método de pago utilizado (ej. Efectivo, Tarjeta).
	 * 
	 * @return Un Optional que contiene la lista de clientes encontrados.
	 */
	...
	/**
	 * Verifica si existe un registro de cliente premium en la base de datos con una
	 * cédula dada. * @param cedula La cédula a verificar.
	 * 
