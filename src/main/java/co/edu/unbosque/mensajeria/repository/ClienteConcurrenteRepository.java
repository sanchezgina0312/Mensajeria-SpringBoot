 ...
 * clientes concurrentes en la base de datos. Extiende de CrudRepository
 * para heredar funcionalidades básicas de CRUD y añade métodos de consulta 
...
public interface ClienteConcurrenteRepository extends CrudRepository<ClienteConcurrente, Long> {
	...
	/**
	 * Busca clientes concurrentes por su nombre completo.
	...
	/**
	 * Busca clientes concurrentes por su número de cédula.
	...
	/**
	 * Busca clientes concurrentes por su número de teléfono.
	 * * @param telefono El teléfono de contacto a consultar.
	 * @return Un  Optional con la lista de clientes encontrados.
	 */
	...
	/**
	 * Busca clientes concurrentes según el tipo de pedido que suelen realizar.
	 * * @param tipoPedido El tipo de pedido a consultar.
	 * @return Un  Optional con la lista de clientes encontrados.
	 */
	public Optional<List<ClienteConcurrente>> findByTipoPedido(String tipoPedido);	
	
	/**
	 * Busca clientes concurrentes que coincidan con un nombre y una cédula específicos.
	...
	/**
	 * Busca clientes concurrentes filtrando por tipo de pedido y método de pago.
	 * * @param tipoPedido El tipo de pedido realizado.
	...
	/**
	 * Verifica la existencia de un cliente concurrente en la base de datos mediante su cédula.
	 * * @param cedula La cédula a comprobar.
