...
/**
 * Excepción personalizada que se lanza cuando se detecta un método de pago
...
public class MetodoDePagoInvalidoException extends RuntimeException {
    ...
    /**
     * Construye una nueva instancia de {@code MetodoDePagoInvalidoException} con el
     ...
     *
     * @param mensaje descripción detallada del motivo por el cual el método
     *                de pago se considera inválido; no debe ser {@code null}.
     */
