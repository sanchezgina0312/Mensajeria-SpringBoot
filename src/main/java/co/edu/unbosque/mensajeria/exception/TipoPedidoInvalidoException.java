...
/**
 * Excepción personalizada que se lanza cuando se detecta un tipo de pedido
 ...
 */
public class TipoPedidoInvalidoException extends RuntimeException {

    /**
     * Construye una nueva instancia de {@code TipoPedidoInvalidoException} con el
     ...
     *                de pedido se considera inválido; no debe ser {@code null}.
     */
    public TipoPedidoInvalidoException(String mensaje) {
        super(mensaje);
    }
}