...
/**
 * Excepción personalizada que se lanza cuando se detecta un identificador
...
public class IdInvalidoException extends RuntimeException {
    ...
    /**
     * Construye una nueva instancia de {@code IdInvalidoException} con el
     ...
     *
     * @param mensaje descripción detallada del motivo por el cual el identificador
