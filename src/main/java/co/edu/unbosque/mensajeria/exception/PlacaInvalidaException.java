...
/**
 * Excepción personalizada que se lanza cuando se detecta una placa con formato
...
public class PlacaInvalidaException extends RuntimeException {
    ...
    /**
     * Construye una nueva instancia de {@code PlacaInvalidaException} con el
     ...
     *
     * @param mensaje descripción detallada del motivo por el cual la placa
