...
/**
 * Excepción personalizada que se lanza cuando se detecta un número de teléfono
...
public class TelefonoInvalidoException extends RuntimeException {
    ...
    /**
     * Construye una nueva instancia de {@code TelefonoInvalidoException} con el
     ...
     *
     * @param mensaje descripción detallada del motivo por el cual el número
     *                de teléfono se considera inválido; no debe ser {@code null}.
     */
