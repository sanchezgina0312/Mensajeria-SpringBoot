...
/**
 * Excepción personalizada que se lanza cuando se detecta un turno con formato
...
public class TurnoInvalidoException extends RuntimeException {
    ...
    /**
     * Construye una nueva instancia de {@code TurnoInvalidoException} con el
     ...
     *
     * @param mensaje descripción detallada del motivo por el cual el turno
