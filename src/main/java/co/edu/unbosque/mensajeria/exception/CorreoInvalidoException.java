...
/**
 * Excepción personalizada que se lanza cuando se detecta un correo electrónico
...
public class CorreoInvalidoException extends RuntimeException {
    ...
    /**
     * Construye una nueva instancia de {@code CorreoInvalidoException} con el
     ...
     *
     * @param mensaje descripción detallada del motivo por el cual el correo
     *                electrónico se considera inválido; no debe ser {@code null}.
     */
