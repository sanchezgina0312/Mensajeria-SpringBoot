...
/**
 * Excepción personalizada que se lanza cuando se detecta un estado de pedido
...
public class EstadoPedidoInvalidoException extends RuntimeException {
    ...
    /**
     * Construye una nueva instancia de {@code EstadoPedidoInvalidoException} con el
     ...
     *
     * @param mensaje descripción detallada del motivo por el cual el estado
     *                del pedido se considera inválido; no debe ser {@code null}.
     */
