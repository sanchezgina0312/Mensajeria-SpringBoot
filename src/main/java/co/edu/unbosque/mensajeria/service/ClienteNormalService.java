 ...
 * 
 * <p>
 * Utiliza ClienteNormalRepository para la persistencia de datos, ModelMapper
 * para la conversión entre entidades y DTOs, y LanzadorDeException para la
...
public class ClienteNormalService implements CRUDOperation<ClienteNormalDTO> {
	...
	public int create(ClienteNormalDTO data) {
		...
		entity.setTarifaNormal(entity.getTarifaNormal());
