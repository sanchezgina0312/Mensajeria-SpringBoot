 ...
 * ClienteConcurrente.
 * <p>
 * Permite crear, consultar, actualizar y eliminar clientes concurrentes, así
 * como realizar búsquedas por diferentes atributos como nombre, cédula, correo,
 * teléfono, método de pago y tipo de pedido.
 * </p>
 * 
 * <p>
 * Utiliza ClienteConcurrenteRepository para la persistencia, ModelMapper para
...
public class ClienteConcurrenteService implements CRUDOperation<ClienteConcurrenteDTO> {
	...
	/**
	 * MÉTODO AGREGADO: Valida las credenciales para el inicio de sesión. * @param
	...
	public List<ClienteConcurrenteDTO> getAll() {
		...
		entityList.forEach(entity -> dtoList.add(mapper.map(entity, ClienteConcurrenteDTO.class)));
